...
static const char* you_win = "The corridor you follow down is carved carefully, polished to a "
                    "shine even now. But it is not straight at all; it curves heavily and spirals "
