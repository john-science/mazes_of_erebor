 ...
 */
void maze_print_medium(WINDOW *win, bool maze[], bool visited[], int max_size, int nrows, int ncols, int player[], int finish[])
{
    ...
    int c_off(1 + (WINDOW_WIDTH - 2 - ncols) / 2);
    int r_off(1 + (WINDOW_HEIGHT - 1 - nrows) / 2);
